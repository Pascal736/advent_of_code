...
class CrateStacks:
    ...
    def execute_moves(self):
        for move in self.moves:
            n = move.n_elements_to_move
            elements = self.stacks[move.source_crate][-n:]
            self.stacks[move.source_crate] = self.stacks[move.source_crate][:-n]
            self.stacks[move.target_crate].extend(elements)
